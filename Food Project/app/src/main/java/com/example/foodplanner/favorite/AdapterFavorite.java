...
public class AdapterFavorite extends RecyclerView.Adapter<AdapterFavorite.ViewHolder> {
    ...
    private com.example.foodplanner.favorite.OnClickItem onclickItem;

    public AdapterFavorite(com.example.foodplanner.favorite.OnClickItem onclickItem, ArrayList<RandomMeal> arr) {
        this.arr = arr;
